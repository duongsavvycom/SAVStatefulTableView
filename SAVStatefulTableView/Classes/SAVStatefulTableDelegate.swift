...
@objc public protocol StatefulTableDelegate: class {
   ...
   */
  func statefulTableViewWillBeginInitialLoad(tvc: SAVStatefulTableView, handler: @escaping InitialLoadCompletionHandler)
  ...
  /**
   ...
   - parameter handler: The completion handler describing if the table is empty and if there is an error.
   */
  func statefulTableViewWillBeginLoadingFromRefresh(tvc: SAVStatefulTableView, handler: @escaping InitialLoadCompletionHandler)
   ...
   */
  func statefulTableViewWillBeginLoadingMore(tvc: SAVStatefulTableView, handler: @escaping LoadMoreCompletionHandler)
   ...
   */
  @objc optional func statefulTableViewViewForInitialLoad(tvc: SAVStatefulTableView) -> UIView?
  ...
  /**
   ...
   - returns: An optional view to show.
   */
  @objc optional func statefulTableViewInitialErrorView(tvc: SAVStatefulTableView, forInitialLoadError: NSError?) -> UIView?
  ...
  /**
   ...
   - returns: An optional view to show.
   */
  @objc optional func statefulTableViewLoadMoreErrorView(tvc: SAVStatefulTableView, forLoadMoreError: NSError?) -> UIView?
}
